...
export const projects = [
    new ProjectModel(
      ...
      projectImgs + 'Cube/Cube2.png',
      projectImgs + 'Cube/Cube3.png'],
      projectVids + 'cubeSolver.mp4'),
    new ProjectModel(
      `Collusion Detection`,
      'HTML CSS JS JQuery SQL',
      `A group project to develop an online trading collusion
      analysis system for Deutsche Bank. Using updates from live or recorded trade data,
      the system builds interactive trading relationship graphs.
      The graphs connects traders based on the likelihood of collusion from
      communication and trading patterns in each stock. The system also features a modular interface and
      a stock analysis tool to help identify correlations between traders and stock activity.`,
      [projectImgs + 'Dbank/Dbank11.png',
      projectImgs + 'Dbank/Dbank2.png'],
      projectVids + 'dbank.mp4'),
    new ProjectModel(
      `Robocode Bot`,
      'Java',
